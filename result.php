...
<div class="row">
    <div class="col-md-12 col-md-offset-3">
        ...
        <div class="text-center card text-white bg-info mb-3" style="max-width: 36rem; margin: 0 auto;">
        ...
        <?php if (isset($_SESSION['age'])) : ?>
            <p><span class="badge badge-primary">Leeftijd:</span> <?php echo $_SESSION['age']; ?></p>   
        <?php endif; ?>

        <?php if (isset($_SESSION['situation'])) : ?>
            <p><span class="badge badge-primary">Situatie:</span> <?php echo $_SESSION['situation']; ?></p> 
        <?php endif; ?>
